...
const create_order_from_cart_dto_1 = require("./dto/create-order-from-cart.dto");
...
let OrdersController = class OrdersController {
    ...
    createFromCart(user, dto) {
        return this.ordersService.createFromCart(user._id.toString(), dto.shippingAddress);
    }
    findMyOrders(user, query) {
